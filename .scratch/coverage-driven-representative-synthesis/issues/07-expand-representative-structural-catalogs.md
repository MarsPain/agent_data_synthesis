# 07 — Expand Representative Structural Catalogs

**What to build:** Add independently executable and verifiable structural
cells that continue to grow beyond the twelve-target preflight, and define one
versioned structural taxonomy that can classify both the prior representative
baseline and later coverage-driven campaigns.
...
Do not run a paid provider pilot, change representative or release thresholds,
increase grounding reuse to manufacture capacity, or optimize against held-out
or downstream benchmark outcomes.
