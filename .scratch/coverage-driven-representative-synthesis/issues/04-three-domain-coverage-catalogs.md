# 04 — Add Three-Domain Coverage Catalogs

**What to build:** Give contacts, mobile messages, and workspace tasks
meaningful versioned coverage catalogs and sufficient deterministic fixture
capacity to exercise structurally distinct, executable, and independently
verifiable task cells through the shared scheduler.
...
Do not add a fourth domain, generate arbitrary tools or executable code, weaken
source governance, or inflate coverage by adding fixture rows that do not
create distinct executable task structure.
