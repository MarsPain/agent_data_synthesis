...
- [exec-plans/active/0012-controlled-network-backed-environment-synthesis.md](exec-plans/active/0012-controlled-network-backed-environment-synthesis.md): current active plan for controlled network-backed environment synthesis.
