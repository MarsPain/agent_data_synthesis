...
- Latest completed work is documented in [docs/exec-plans/completed/0009-multi-path-branching-trajectory-foundation.md](docs/exec-plans/completed/0009-multi-path-branching-trajectory-foundation.md).
