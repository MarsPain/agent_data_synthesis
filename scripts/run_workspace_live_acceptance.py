...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run one explicitly authorized live Workspace acceptance, freeze "
            "sanitized provider evidence, and build its tracer proof."
        )
    )
    parser.add_argument(
        ...
        action="store_true",
        required=True,
        help="Required explicit authorization for the paid/provider-backed run.",
    )
